...
public class CodeGenerator {
    ...
    // 数据源配置
    private static final DataSourceConfig.Builder DATA_SOURCE_CONFIG = new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/system_design?serverTimezone=GMT%2B8", "root", "root")
    ...
    public void generatorCode() {
        FastAutoGenerator
                ...
                .packageConfig(builder -> {
                    builder.parent("com.system.design") // 设置父包名
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("t_manager_system_notice", "t_user_system_notice") // 设置需要生成的表名
